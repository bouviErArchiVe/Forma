...
export const CONSTRUCTION_DETAILS: ConstructionDetail[] = [
  ...
  // ─── A3 vers 100+ (expansion) ────────────────────────────────────────────────
  {
    id: 'd-found-thickened', name: 'Dalle épaissie en rive', category: 'fondations',
    description: 'Dalle sur sol épaissie en rive servant de fondation périphérique.',
    tags: ['dalle', 'épaissie', 'rive', 'fondation', 'monolithique'],
    notes: 'Épaississement de rive descendu sous le gel (à vérifier) ; isolant périphérique pour rompre le pont thermique, armatures selon calcul.',
    width: 160, height: 110,
    svgBody: '<path d="M20 40 H150 V52 H40 V90 H20 Z"/><rect x="10" y="40" width="10" height="50" stroke-dasharray="3 3"/><path d="M28 60 H32 M28 70 H32 M28 80 H32" stroke-width="1"/>',
  },
  {
    id: 'd-found-helical', name: 'Pieu hélicoïdal', category: 'fondations',
    description: 'Pieu vissé hélicoïdal avec tête de raccordement.',
    tags: ['pieu', 'hélicoïdal', 'vissé', 'fondation profonde'],
    notes: 'Capacité selon couple d’installation et sol (à vérifier) ; tête raccordée à la structure, protection contre la corrosion en sol agressif.',
    width: 120, height: 160,
    svgBody: '<rect x="52" y="14" width="16" height="20"/><path d="M60 34 V140" stroke-width="3"/><path d="M44 120 Q60 112 76 120" stroke-width="2"/><path d="M44 132 Q60 124 76 132" stroke-width="2"/>',
  },
  {
    id: 'd-found-step', name: 'Semelle en redan', category: 'fondations',
    description: 'Semelle filante à redans suivant une pente de terrain.',
    tags: ['semelle', 'redan', 'pente', 'fondation', 'gradins'],
    notes: 'Redans pour suivre la pente tout en restant sous le gel ; recouvrement d’armatures aux décrochements, rapport hauteur/longueur limité.',
    width: 180, height: 130,
    svgBody: '<path d="M20 40 H80 V70 H140 V100 H170" stroke-width="2"/><path d="M20 55 H80 V85 H140 V115 H170" stroke-width="2"/><path d="M20 40 V55 M170 100 V115" />',
  },
  {
    id: 'd-wall-sip', name: 'Panneau structural isolé (SIP)', category: 'murs',
    description: 'Âme isolante entre deux peaux structurales (OSB).',
    tags: ['sip', 'panneau', 'structural', 'isolé', 'mur'],
    notes: 'Le panneau est structural et étanche à l’air ; soigner les joints (mousse + ruban) et la gestion de l’humidité aux pénétrations.',
    width: 150, height: 120,
    svgBody: '<rect x="40" y="10" width="6" height="100"/><rect x="46" y="10" width="40" height="100" stroke-dasharray="3 3"/><rect x="86" y="10" width="6" height="100"/>',
  },
  {
    id: 'd-wall-cavity', name: 'Mur creux de maçonnerie', category: 'murs',
    description: 'Deux parois de maçonnerie séparées par une lame d’air drainée.',
    tags: ['mur creux', 'cavity', 'maçonnerie', 'lame d’air', 'attaches'],
    notes: 'Lame d’air drainée avec chantepleures et solins ; attaches entre parois, isolant rigide possible dans la cavité.',
    width: 160, height: 120,
    svgBody: '<rect x="30" y="10" width="18" height="100"/><rect x="78" y="10" width="18" height="100"/><path d="M48 30 H78 M48 60 H78 M48 90 H78" stroke-width="1" stroke-dasharray="2 3"/><path d="M86 100 l-6 6"/>',
  },
  {
    id: 'd-wall-furred', name: 'Mur à fourrures isolées', category: 'murs',
    description: 'Fourrures intérieures créant un espace isolé et technique.',
    tags: ['fourrures', 'isolation', 'mur', 'service', 'pare-vapeur'],
    notes: 'Espace de service côté intérieur ; pare-vapeur/air bien positionné selon le climat, éviter le double pare-vapeur.',
    width: 160, height: 120,
    svgBody: '<rect x="30" y="10" width="24" height="100"/><rect x="54" y="10" width="20" height="100" stroke-dasharray="3 3"/><rect x="74" y="10" width="6" height="100"/><rect x="80" y="10" width="6" height="100"/>',
  },
  {
    id: 'd-wall-retaining', name: 'Mur de soutènement', category: 'beton',
    description: 'Mur de soutènement en béton avec drainage à l’arrière.',
    tags: ['soutènement', 'béton', 'drainage', 'poussée', 'remblai'],
    notes: 'Dimensionné pour la poussée des terres (à vérifier) ; drainage et barbacanes à l’arrière, semelle et clé anti-glissement.',
    width: 150, height: 150,
    svgBody: '<path d="M50 20 L62 20 L70 130 L30 130 Z"/><path d="M30 130 H120 V145 H30 Z"/><path d="M70 40 Q90 60 80 120" stroke-dasharray="3 3"/><circle cx="78" cy="120" r="4"/>',
  },
  {
    id: 'd-roof-snow-stop', name: 'Arrêt de neige (toiture)', category: 'toitures',
    description: 'Dispositif d’arrêt de neige sur toiture en pente.',
    tags: ['neige', 'arrêt', 'toiture', 'pente', 'sécurité'],
    notes: 'Retient la neige pour éviter les avalanches ; fixation dans la structure et étanchéité au droit des supports.',
    width: 170, height: 110,
    svgBody: '<path d="M20 90 L150 30" stroke-width="2"/><path d="M70 64 V50 M72 64 V50 M90 53 V39 M92 53 V39" stroke-width="2"/><path d="M66 50 H96"/>',
  },
  {
    id: 'd-roof-gutter', name: 'Gouttière de rive', category: 'toitures',
    description: 'Gouttière en rive de toiture avec larmier.',
    tags: ['gouttière', 'rive', 'toiture', 'évacuation', 'larmier'],
    notes: 'Pente vers la descente, larmier dirigeant l’eau dans la gouttière ; débord et fixations résistant à la charge de glace.',
    width: 160, height: 110,
    svgBody: '<path d="M20 40 L110 70" stroke-width="2"/><path d="M110 70 L120 78" /><path d="M118 74 a10 10 0 1 0 18 6 L132 80 Z" stroke-width="1.6"/>',
  },
  {
    id: 'd-roof-drip-edge', name: 'Larmier de rive (membrane)', category: 'toitures',
    description: 'Profilé de rive (drip edge) sous membrane de toiture.',
    tags: ['larmier', 'drip edge', 'rive', 'membrane', 'toiture'],
    notes: 'Le larmier dirige l’eau hors de la rive ; membrane retournée sur le profilé, fixation et recouvrement selon le sens d’écoulement.',
    width: 160, height: 100,
    svgBody: '<path d="M20 40 H120" stroke-width="2"/><path d="M20 46 H122 L128 56" /><path d="M122 46 V60 L116 66" stroke-width="1.6"/>',
  },
  {
    id: 'd-floor-mezzanine', name: 'Plancher de mezzanine', category: 'planchers',
    description: 'Plancher de mezzanine sur poutre, avec garde-corps.',
    tags: ['mezzanine', 'plancher', 'poutre', 'garde-corps'],
    notes: 'Charge d’exploitation et garde-corps selon l’usage (à vérifier) ; appui sur poutre et continuité du diaphragme.',
    width: 180, height: 120,
    svgBody: '<path d="M20 60 H140 M20 66 H140" stroke-width="2"/><rect x="120" y="66" width="14" height="44"/><path d="M30 60 V20 M30 20 H60" stroke-width="2"/><path d="M30 36 H60 M30 48 H60" stroke-width="1"/>',
  },
  {
    id: 'd-floor-floating', name: 'Chape flottante (acoustique)', category: 'planchers',
    description: 'Chape désolidarisée sur isolant acoustique.',
    tags: ['chape', 'flottante', 'acoustique', 'plancher', 'désolidarisée'],
    notes: 'La chape flottante coupe la transmission des bruits d’impact ; bande périphérique résiliente et aucun pont rigide en rive.',
    width: 180, height: 90,
    svgBody: '<rect x="20" y="20" width="140" height="16"/><path d="M20 38 H160" stroke-dasharray="2 2"/><path d="M20 44 H160" stroke-width="2"/><path d="M22 20 V44 M158 20 V44" stroke-width="1"/>',
  },
  {
    id: 'd-floor-stepdown', name: 'Ressaut de plancher', category: 'planchers',
    description: 'Décrochement de niveau entre deux planchers.',
    tags: ['ressaut', 'décrochement', 'niveau', 'plancher'],
    notes: 'Continuité structurale et du pare-air au décrochement ; gérer l’accessibilité et la signalisation du changement de niveau.',
    width: 170, height: 110,
    svgBody: '<path d="M20 40 H90 V70 H150" stroke-width="2"/><path d="M20 46 H90 V76 H150" /><rect x="40" y="46" width="10" height="30"/><rect x="110" y="76" width="10" height="24"/>',
  },
  {
    id: 'd-door-jamb-frame', name: 'Jambage de porte (cadre)', category: 'portes-fenetres',
    description: 'Cadre de porte avec jeu de pose et calfeutrage.',
    tags: ['porte', 'jambage', 'cadre', 'calfeutrage', 'pose'],
    notes: 'Jeu de pose calé et calfeutré, fond de joint et scellant ; continuité du pare-air autour du cadre, ancrages réguliers.',
    width: 140, height: 130,
    svgBody: '<rect x="40" y="10" width="14" height="110" stroke-dasharray="3 3"/><rect x="54" y="10" width="8" height="110"/><rect x="62" y="20" width="50" height="90"/><path d="M54 24 v6 m0 30 v6 m0 30 v6" stroke-width="1"/>',
  },
  {
    id: 'd-window-mullion', name: 'Meneau de fenêtre', category: 'portes-fenetres',
    description: 'Meneau vertical raccordant deux châssis vitrés.',
    tags: ['fenêtre', 'meneau', 'mullion', 'vitrage', 'jonction'],
    notes: 'Le meneau reprend les efforts et assure l’étanchéité entre châssis ; rupture de pont thermique et drainage selon le système.',
    width: 150, height: 120,
    svgBody: '<rect x="66" y="10" width="14" height="100"/><path d="M73 10 V110" stroke-dasharray="2 4"/><rect x="24" y="20" width="42" height="80"/><rect x="80" y="20" width="42" height="80"/>',
  },
  {
    id: 'd-door-garage', name: 'Porte de garage sectionnelle', category: 'portes-fenetres',
    description: 'Coupe d’une porte sectionnelle avec linteau et rails.',
    tags: ['porte', 'garage', 'sectionnelle', 'linteau', 'rail'],
    notes: 'Linteau dimensionné pour la portée (à vérifier) ; étanchéité périphérique et seuil, dégagement pour les rails et le mécanisme.',
    width: 170, height: 120,
    svgBody: '<rect x="40" y="20" width="100" height="14"/><rect x="46" y="40" width="88" height="14"/><rect x="46" y="58" width="88" height="14"/><rect x="46" y="76" width="88" height="14"/><path d="M40 96 H140" stroke-width="2"/>',
  },
  {
    id: 'd-iso-attic-baffle', name: 'Déflecteur d’isolation de comble', category: 'isolation',
    description: 'Déflecteur maintenant le passage d’air au-dessus de l’isolant.',
    tags: ['comble', 'isolation', 'déflecteur', 'ventilation', 'soufflée'],
    notes: 'Le déflecteur préserve la ventilation depuis le soffite au-dessus de l’isolant soufflé ; pare-air au plafond continu.',
    width: 170, height: 110,
    svgBody: '<path d="M20 30 L150 80" stroke-width="2"/><path d="M30 92 H150" stroke-width="2"/><path d="M40 90 Q44 64 70 56" stroke-width="1.6"/><path d="M50 92 q10 -6 20 0 t20 0 t20 0" stroke-width="1"/>',
  },
  {
    id: 'd-iso-basement-int', name: 'Isolation intérieure de sous-sol', category: 'isolation',
    description: 'Isolation du mur de sous-sol par l’intérieur avec finition.',
    tags: ['sous-sol', 'isolation', 'intérieur', 'mur', 'finition'],
    notes: 'Gérer le séchage du mur enterré ; isolant peu sensible à l’humidité au contact du béton, pare-vapeur selon la stratégie.',
    width: 150, height: 150,
    svgBody: '<rect x="40" y="10" width="22" height="130"/><rect x="62" y="10" width="16" height="130" stroke-dasharray="3 3"/><rect x="78" y="10" width="6" height="130"/>',
  },
  {
    id: 'd-iso-cavity-foam', name: 'Mousse giclée en cavité', category: 'isolation',
    description: 'Cavité d’ossature remplie de mousse de polyuréthane giclée.',
    tags: ['mousse', 'giclée', 'polyuréthane', 'cavité', 'pare-air'],
    notes: 'La mousse cellules fermées isole et étanchéifie à l’air ; respecter les épaisseurs par passe et la barrière thermique.',
    width: 150, height: 120,
    svgBody: '<rect x="30" y="10" width="8" height="100"/><rect x="78" y="10" width="8" height="100"/><path d="M38 14 q10 6 20 0 t20 0 M38 30 q10 6 20 0 t20 0 M38 46 q10 6 20 0 t20 0 M38 62 q10 6 20 0 t20 0 M38 78 q10 6 20 0 t20 0 M38 94 q10 6 20 0 t20 0" stroke-width="1"/>',
  },
  {
    id: 'd-drain-window-well', name: 'Margelle de soupirail drainée', category: 'drainage',
    description: 'Margelle (window well) drainée devant un soupirail.',
    tags: ['soupirail', 'margelle', 'window well', 'drainage', 'sous-sol'],
    notes: 'Margelle avec gravier et raccord au drain de fondation ; couvercle/grille pour limiter eau et débris, évacuation vers l’exutoire.',
    width: 150, height: 130,
    svgBody: '<rect x="40" y="20" width="14" height="100"/><rect x="44" y="50" width="10" height="40" stroke-dasharray="2 2"/><path d="M54 110 Q90 110 100 60" stroke-width="1.6"/><circle cx="70" cy="104" r="3"/>',
  },
  {
    id: 'd-drain-area', name: 'Drain de surface (area drain)', category: 'drainage',
    description: 'Avaloir de surface raccordé au réseau pluvial.',
    tags: ['drain', 'surface', 'avaloir', 'pluvial', 'grille'],
    notes: 'Pente du dallage vers l’avaloir, grille amovible et siphon ; raccord au réseau et profondeur hors gel à vérifier.',
    width: 160, height: 100,
    svgBody: '<path d="M20 40 H70 L80 56 L90 40 H140" stroke-width="2"/><rect x="70" y="56" width="20" height="10"/><path d="M80 66 V80 a8 8 0 0 0 16 0 V70" stroke-width="1.6"/><path d="M72 60 H88 M74 56 V66 M82 56 V66"/>',
  },
  {
    id: 'd-steel-deck-shear', name: 'Connecteur tablier-poutre', category: 'structure-acier',
    description: 'Goujon connecteur entre dalle sur tablier et poutre acier.',
    tags: ['acier', 'tablier', 'goujon', 'connecteur', 'mixte'],
    notes: 'Les goujons assurent l’action mixte acier-béton (à vérifier au calcul) ; soudure des goujons et enrobage de la dalle.',
    width: 170, height: 110,
    svgBody: '<path d="M20 40 H150" stroke-width="2"/><path d="M20 30 q8 -8 16 0 t16 0 t16 0 t16 0 t16 0 t16 0 t16 0" stroke-width="1"/><path d="M60 40 V26 h6 M100 40 V26 h6" stroke-width="2"/><path d="M70 40 H100 M70 58 H100 M85 40 V58" stroke-width="3"/>',
  },
  {
    id: 'd-steel-purlin', name: 'Panne acier (Z)', category: 'structure-acier',
    description: 'Panne formée à froid (profil Z) supportant la couverture.',
    tags: ['acier', 'panne', 'profil z', 'couverture', 'formé à froid'],
    notes: 'Panne fixée aux fermes/portiques, entretoises anti-déversement ; fixations de couverture selon soulèvement au vent.',
    width: 140, height: 130,
    svgBody: '<path d="M50 20 H80 L70 40 V90 H100" stroke-width="3"/><path d="M30 110 H110" stroke-width="2"/><path d="M68 90 V108" />',
  },
  {
    id: 'd-concrete-slab-mesh', name: 'Treillis d’armature de dalle', category: 'beton',
    description: 'Treillis soudé positionné dans une dalle de béton.',
    tags: ['béton', 'treillis', 'armature', 'dalle', 'retrait'],
    notes: 'Treillis positionné à la bonne hauteur (cales) pour contrôler la fissuration de retrait ; recouvrements et enrobage respectés.',
    width: 180, height: 90,
    svgBody: '<rect x="10" y="24" width="160" height="20"/><path d="M20 34 H160" stroke-dasharray="6 6" stroke-width="1.4"/><path d="M40 28 V40 M70 28 V40 M100 28 V40 M130 28 V40" stroke-width="1"/><path d="M30 44 l4 4 m20 -4 l4 4 m20 -4 l4 4 m20 -4 l4 4 m20 -4 l4 4" stroke-width="1"/>',
  },
  {
    id: 'd-concrete-tiltup', name: 'Mur tilt-up (panneau basculé)', category: 'beton',
    description: 'Panneau de béton préfabriqué basculé et raccordé.',
    tags: ['béton', 'tilt-up', 'panneau', 'préfabriqué', 'levage'],
    notes: 'Panneau coulé au sol puis basculé ; ancrages de levage, joints entre panneaux étanches et raccord au diaphragme de toit.',
    width: 140, height: 150,
    svgBody: '<rect x="50" y="14" width="20" height="120"/><rect x="74" y="14" width="20" height="120"/><path d="M70 14 V134 M72 14 V134" stroke-dasharray="2 3"/><path d="M40 134 H110 V146 H40 Z"/>',
  },
  {
    id: 'd-wood-post-base', name: 'Base de poteau bois', category: 'structure-bois',
    description: 'Pied de poteau bois sur platine métallique surélevée.',
    tags: ['bois', 'poteau', 'base', 'platine', 'humidité'],
    notes: 'Platine surélevant le bois au-dessus de l’eau, ancrée au béton ; ventilation du pied et protection contre l’humidité.',
    width: 120, height: 150,
    svgBody: '<rect x="48" y="14" width="24" height="80"/><path d="M50 94 H70 M58 94 V108 M62 94 V108" stroke-width="2"/><rect x="44" y="108" width="32" height="6"/><rect x="38" y="114" width="44" height="24" stroke-dasharray="3 3"/>',
  },
  {
    id: 'd-wood-truss', name: 'Ferme de toit (treillis bois)', category: 'structure-bois',
    description: 'Ferme légère en bois à connecteurs (toiture).',
    tags: ['bois', 'ferme', 'treillis', 'toiture', 'connecteurs'],
    notes: 'Ferme préfabriquée à plaques de connexion ; ne pas couper/modifier sans ingénieur, contreventement et ancrages au vent.',
    width: 190, height: 110,
    svgBody: '<path d="M15 90 L95 20 L175 90 Z" stroke-width="2"/><path d="M15 90 H175"/><path d="M95 20 V90 M55 55 L95 90 M135 55 L95 90 M55 55 L55 90 M135 55 L135 90"/>',
  },
]
