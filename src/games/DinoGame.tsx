...
export default function DinoGame({ T, onClose, bestScore = 0, onSaveScore }: GameProps) {
  const canvasRef = useRef<HTMLCanvasElement>(null)
  const stateRef = useRef<DinoState | null>(null)
  ...
  return (
    <GameShell
      T={T}
      title="Dino Run"
      hint="Espace ou toucher pour sauter"
      score={score}
      best={bestScore}
      onClose={onClose}
    >
