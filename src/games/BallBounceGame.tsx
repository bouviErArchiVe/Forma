...
export default function BallBounceGame({ T, onClose, bestScore = 0, onSaveScore }: GameProps) {
  ...
  useEffect(() => {
    ...
    const onTap = () => {
      if (stateRef.current && !stateRef.current.alive) reset()
    }
