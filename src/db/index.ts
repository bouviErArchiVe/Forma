...
export class FormaDatabase extends Dexie {
  ...
  constructor() {
    ...
    // v16 : objectifs académiques (additif, non destructif). subjectId pour
    // filtrer par matière ; dueDate (chaîne ISO) indexé pour le tri par échéance ;
    // updatedAt pour la récence.
